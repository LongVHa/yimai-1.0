	...
	display:none!important;
	  ...
	  ?>
			...
			<?php else : ?>
				...
				<h3 class="page-title news-listing-title"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></h3>
		 ...
		 */
		get_template_part( 'news-listing', get_post_format() ); ?>
      ...
      <?php else : ?>
		...
		?>
          ...
          <p class="center">
          <?php _e( 'Apologies, but no results were found.', 'bootstrapcanvaswp' ); ?></p>
