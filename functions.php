...
function bootstrapcanvaswp_setup() {
	...
	register_nav_menus( array(
		...
		'secondary' => __( 'Secondary Menu', 'bottom' )
	) );
...
function bootstrapcanvaswp_scripts() {
	...
	wp_enqueue_script( 'nav-icon-js', get_template_directory_uri() . '/js/nav-toggle.js', array( 'jquery' ), '1.4.2' );
...
function bootstrapcanvaswp_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Fifth Footer Widget Area', 'bootstrapcanvaswp' ),
...
//yimai Mandarin sidebar
function yimai_mn_widgets_innit(){
    register_sidebar( array(
        'name' => __( 'MN First Footer Widget Area', 'yimai-widget' ),
        'id' => 'mn-first-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
	...
	register_sidebar( array(
        'name' => __( 'MN Second Footer widget Area', 'yimai-widget' ),
        'id' => 'mn-second-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'MN Third Footer Widget Area', 'yimai-widget' ),
        'id' => 'mn-third-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'MN Fourth Footer Widget Area', 'yimai-widget' ),
        'id' => 'mn-fourth-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'MN Fifth Footer Widget Area', 'yimai-widget' ),
        'id' => 'mn-fifth-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
...
add_action('widgets_init', 'yimai_mn_widgets_innit');

// Add Cantonese sidebar
function yimai_ct_widgets_innit(){
    register_sidebar( array(
        'name' => __( 'CT First Footer Widget Area', 'yimai-widget' ),
        'id' => 'ct-first-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'CT Second Footer widget Area', 'yimai-widget' ),
        'id' => 'ct-second-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'CT Third Footer Widget Area', 'yimai-widget' ),
        'id' => 'ct-third-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'CT Fourth Footer Widget Area', 'yimai-widget' ),
        'id' => 'ct-fourth-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
	...
	register_sidebar( array(
        'name' => __( 'CT Fifth Footer Widget Area', 'yimai-widget' ),
        'id' => 'ct-fifth-widget-area',
        'description' => __( 'Add widgets here to appear in your sidebar.', 'yimai-widget' ),
		'before_widget' => '<div id="%1$s" class="sidebar-module widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4>',
...
add_action('widgets_init', 'yimai_ct_widgets_innit');
/**
...
function new_excerpt_more($more) {
    global $post;
    return ' ... <div class="cont-reading-wrap"><a href="'. get_permalink($post->ID) . '"><br>Continue reading &raquo;</a></div>';
}
add_filter('excerpt_more', 'new_excerpt_more');

// Blog listing title active link 
...
//excerpt chinese characters
function dez_filter_chinese_excerpt( $output ) {
global $post;

$cont_reading_txt ='continue reading &raquo;';

	if(is_category(8)){ //ct
		$cont_reading_txt ='繼續閱讀 &raquo;';
		
	}else if(is_category(7)){//mn
		$cont_reading_txt ='继续阅读 &raquo;';
	}

//check if its chinese character input
$chinese_output = preg_match_all("/\p{Han}+/u", $post->post_content, $matches);
if($chinese_output) {
$output = mb_substr( $output, 0, 120 ) . ' ... <div class="cont-reading-wrap"><a href="'. get_permalink($post->ID) . '"><br>'. $cont_reading_txt .'</a></div>';
}
return $output;
}
